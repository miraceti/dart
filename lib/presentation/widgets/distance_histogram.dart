    ...
    return Column(
      children: [
        ...
        Wrap(
          ...
          runSpacing: 4,
          children: const [
            _Legend(color: Colors.green, text: "0–10 pc"),
            _Legend(color: Colors.lightGreen, text: "10–25 pc"),
            _Legend(color: Colors.blue, text: "25–50 pc"),
            _Legend(color: Colors.indigo, text: "50–100 pc"),
            _Legend(color: Colors.orange, text: "100–250 pc"),
            _Legend(color: Colors.red, text: "250+ pc"),
